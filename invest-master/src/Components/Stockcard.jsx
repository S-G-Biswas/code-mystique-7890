...
const Cardstock = ({ data }) => {
  ...
  return (
    <div style={{ backgroundColor:"black" , display: 'flex', justifyContent: 'center', alignItems: 'center', margin: '0 auto', padding: '10px', maxWidth: '100%' }}>
      <SimpleGrid spacing={10} templateColumns='repeat(auto-fill, minmax(200px, 1fr))' alignItems='center' justifyContent='center' maxWidth='100%'>
        {data.map((item, index) => (
          ...
          <ModalBody>
            {selectedStock && (
              <>
                ...
                <Text>Price: {selectedStock.price}</Text>
